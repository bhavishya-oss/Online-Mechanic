<html>
    ...
    <body class="publicbodytheme">
        ...
        <form action="deleteadminjavacode.jsp">
        <table cellpadding="16" cellspacing="2" class = logintab border="0">
            <tr>
                <td>Operator Id</td>
                <td><input type = text placeholder = "Enter your operator ID" name = "oId" class = "texttheme"></td>
            </tr>
            <tr>
            ...
            <tr>
                <td>Admin Id</td>
                <td><input type = text placeholder = "Enter Admin Id" name = "aId" class = "texttheme"></td>
            </tr>
